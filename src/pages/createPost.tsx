  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      ...
      <form className="bg-white p-6 rounded shadow-md w-96" onSubmit={(e) => {
        ...
        <input type="text" name="title" className="w-full p-2 border border-gray-300 rounded mb-4" placeholder="Post Title" required /> {/* Input for post title */}
        <input type="file" name="image" accept="image/*" className="mb-4" /> {/* Input for image upload */}
        <input type="text" name="video" className="w-full p-2 border border-gray-300 rounded mb-4" placeholder="Video URL (optional)" /> {/* Input for video URL */}
